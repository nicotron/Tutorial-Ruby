...
results = client.query("INSERT INTO registros (nom, fecha, hora) VALUES  ('#{client.escape(nombre)}', '#{client.escape(fecha_completa)}', '#{client.escape(hora_completa)}')")
